...
class Booking extends BaseController
{
    ...
    function bookingListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Mission Transit, LLC : Booking';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'Mission Transit, LLC : Add New Booking';
    ...
    function edit($bookingId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Mission Transit, LLC : Edit Booking';
