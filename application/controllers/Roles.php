...
class Roles extends BaseController
{
    ...
    function roleListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Mission Transit, LLC : Roles Listing';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'Mission Transit, LLC : Add New Role';
    ...
    function edit($roleId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Mission Transit, LLC : Edit Role';
