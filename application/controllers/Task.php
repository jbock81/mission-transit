...
class Task extends BaseController
{
    ...
    function taskListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Mission Transit, LLC : Task';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'Mission Transit, LLC : Add New Task';
    ...
    function edit($taskId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Mission Transit, LLC : Edit Task';
